...
class UnivVars(Structure):
	_fields_ = [("type",c_ushort),("method",c_ushort),("max_s",c_ushort),("max_parents",c_ushort),
			...
			("discont_size",c_uint),("max_localorder",c_uint),
			("uses_dam",c_ushort),("global_params",POINTER(VEC)),
			("params_size",c_uint),("dam_params_size",c_uint),("disk_params",c_uint),
			("area_idx",c_uint),("areah_idx",c_uint),("rain_filename",c_char_p),("init_filename",c_char_p),
			("rvr_filename",c_char_p),("prm_filename",c_char_p),("init_flag",c_ushort),("rvr_flag",c_ushort),
			("prm_flag",c_ushort),("output_flag",c_ushort),("temp_filename",c_char_p),("dam_filename",c_char_p),
			("print_time",c_double),("print_par_flag",c_ushort),("dam_flag",c_ushort),("hydrosave_flag",c_ushort),
			("peaksave_flag",c_ushort),("hydrosave_filename",c_char_p),("peaksave_filename",c_char_p),("peakfilename",c_char_p),
			("max_dim",c_uint),("outletlink",c_uint),("string_size",c_uint),
			("query_size",c_uint),("rkd_flag",c_short),("convertarea_flag",c_ushort),("discont_tol",c_double),
			("num_forcings",c_uint),("hydros_loc_flag",c_ushort),("peaks_loc_flag",c_ushort),
			("dump_loc_flag",c_ushort),("res_flag",c_ushort),("hydros_loc_filename",c_char_p),("peaks_loc_filename",c_char_p),
			("dump_loc_filename",c_char_p),("rsv_filename",c_char_p),("init_timestamp",c_uint),("res_forcing_idx",c_ushort),
			("num_states_for_printing",c_uint),("num_print",c_uint),("print_indices",POINTER(c_uint)),
