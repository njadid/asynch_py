...
int BuildSaveLists(Link* system, unsigned int N, unsigned int* my_sys, unsigned int my_N, int* assignments, unsigned int** id_to_loc, GlobalVars* GlobalVars, unsigned int** save_list, unsigned int* save_size, unsigned int* my_save_size, unsigned int** peaksave_list, unsigned int* peaksave_size, unsigned int* my_peaksave_size, ConnData* db_connections);
int FinalizeSystem(Link* system, unsigned int N, unsigned int* my_sys, unsigned int my_N, int* assignments, short int* getting, unsigned int** id_to_loc, TransData* my_data, GlobalVars* GlobalVars, ConnData* db_connections, TempStorage** workspace);
